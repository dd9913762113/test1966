...
NSString * const DBJKeyChainStoreErrorDomain = @"com.kishikawakatsumi.DBJKeyChainStore";
static NSString *_defaultService;

@interface DBJKeyChainStore ()

@end

@implementation DBJKeyChainStore
...
+ (DBJKeyChainStore *)keyChainStoreWithService:(NSString *)service
{
    return [[self alloc] initWithService:service accessGroup:nil];
}

+ (DBJKeyChainStore *)keyChainStoreWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
...
{
    return [[self alloc] initWithServer:server protocolType:protocolType authenticationType:DBJKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithService:(NSString *)service accessGroup:(NSString *)accessGroup
{
    self = [super init];
    if (self) {
        _itemClass = DBJKeyChainStoreItemClassGenericPassword;
...
{
    return [self initWithServer:server protocolType:protocolType authenticationType:DBJKeyChainStoreAuthenticationTypeDefault];
}
...
- (instancetype)initWithServer:(NSURL *)server protocolType:(DBJKeyChainStoreProtocolType)protocolType authenticationType:(DBJKeyChainStoreAuthenticationType)authenticationType
{
    self = [super init];
    if (self) {
        _itemClass = DBJKeyChainStoreItemClassInternetPassword;
...
- (void)commonInit
{
    _accessibility = DBJKeyChainStoreAccessibilityAfterFirstUnlock;
...
+ (NSString *)stringForKey:(NSString *)key service:(NSString *)service accessGroup:(NSString *)accessGroup error:(NSError *__autoreleasing *)error
{
    ...
    DBJKeyChainStore *keychain = [DBJKeyChainStore keyChainStoreWithService:service accessGroup:accessGroup];
...
+ (NSArray UIC_KEY_TYPE *)allKeysWithItemClass:(DBJKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == DBJKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
    } else if (itemClass == DBJKeyChainStoreItemClassInternetPassword) {
...
+ (NSArray *)allItemsWithItemClass:(DBJKeyChainStoreItemClass)itemClass
{
    CFTypeRef itemClassObject = kSecClassGenericPassword;
    if (itemClass == DBJKeyChainStoreItemClassGenericPassword) {
        itemClassObject = kSecClassGenericPassword;
...
- (NSMutableDictionary *)attributesWithKey:(NSString *)key value:(NSData *)value error:(NSError *__autoreleasing *)error
{
    ...
    if (_authenticationPolicy && accessibilityObject) {
        ...
        if (floor(NSFoundationVersionNumber) <= floor(iOS_7_1_or_10_9_2) && _accessibility == DBJKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly) {
#if TARGET_OS_IOS
            NSLog(@"%@", @"Unavailable 'DBJKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on iOS versions prior to 8.0.");
#else
            NSLog(@"%@", @"Unavailable 'DBJKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly' attribute on OS X versions prior to 10.10.");
#endif
        } else {
...
{
    switch (_itemClass) {
        case DBJKeyChainStoreItemClassGenericPassword:
            return kSecClassGenericPassword;
        case DBJKeyChainStoreItemClassInternetPassword:
...
- (CFTypeRef)protocolTypeObject
{
    switch (_protocolType) {
        case DBJKeyChainStoreProtocolTypeFTP:
            return kSecAttrProtocolFTP;
        case DBJKeyChainStoreProtocolTypeFTPAccount:
            return kSecAttrProtocolFTPAccount;
        case DBJKeyChainStoreProtocolTypeHTTP:
            return kSecAttrProtocolHTTP;
        case DBJKeyChainStoreProtocolTypeIRC:
            return kSecAttrProtocolIRC;
        case DBJKeyChainStoreProtocolTypeNNTP:
            return kSecAttrProtocolNNTP;
        case DBJKeyChainStoreProtocolTypePOP3:
            return kSecAttrProtocolPOP3;
        case DBJKeyChainStoreProtocolTypeSMTP:
            return kSecAttrProtocolSMTP;
        case DBJKeyChainStoreProtocolTypeSOCKS:
            return kSecAttrProtocolSOCKS;
        case DBJKeyChainStoreProtocolTypeIMAP:
            return kSecAttrProtocolIMAP;
        case DBJKeyChainStoreProtocolTypeLDAP:
            return kSecAttrProtocolLDAP;
        case DBJKeyChainStoreProtocolTypeAppleTalk:
            return kSecAttrProtocolAppleTalk;
        case DBJKeyChainStoreProtocolTypeAFP:
            return kSecAttrProtocolAFP;
        case DBJKeyChainStoreProtocolTypeTelnet:
            return kSecAttrProtocolTelnet;
        case DBJKeyChainStoreProtocolTypeSSH:
            return kSecAttrProtocolSSH;
        case DBJKeyChainStoreProtocolTypeFTPS:
            return kSecAttrProtocolFTPS;
        case DBJKeyChainStoreProtocolTypeHTTPS:
            return kSecAttrProtocolHTTPS;
        case DBJKeyChainStoreProtocolTypeHTTPProxy:
            return kSecAttrProtocolHTTPProxy;
        case DBJKeyChainStoreProtocolTypeHTTPSProxy:
            return kSecAttrProtocolHTTPSProxy;
        case DBJKeyChainStoreProtocolTypeFTPProxy:
            return kSecAttrProtocolFTPProxy;
        case DBJKeyChainStoreProtocolTypeSMB:
            return kSecAttrProtocolSMB;
        case DBJKeyChainStoreProtocolTypeRTSP:
            return kSecAttrProtocolRTSP;
        case DBJKeyChainStoreProtocolTypeRTSPProxy:
            return kSecAttrProtocolRTSPProxy;
        case DBJKeyChainStoreProtocolTypeDAAP:
            return kSecAttrProtocolDAAP;
        case DBJKeyChainStoreProtocolTypeEPPC:
            return kSecAttrProtocolEPPC;
        case DBJKeyChainStoreProtocolTypeNNTPS:
            return kSecAttrProtocolNNTPS;
        case DBJKeyChainStoreProtocolTypeLDAPS:
            return kSecAttrProtocolLDAPS;
        case DBJKeyChainStoreProtocolTypeTelnetS:
            return kSecAttrProtocolTelnetS;
        case DBJKeyChainStoreProtocolTypeIRCS:
            return kSecAttrProtocolIRCS;
        case DBJKeyChainStoreProtocolTypePOP3S:
...
- (CFTypeRef)authenticationTypeObject
{
    switch (_authenticationType) {
        case DBJKeyChainStoreAuthenticationTypeNTLM:
            return kSecAttrAuthenticationTypeNTLM;
        case DBJKeyChainStoreAuthenticationTypeMSN:
            return kSecAttrAuthenticationTypeMSN;
        case DBJKeyChainStoreAuthenticationTypeDPA:
            return kSecAttrAuthenticationTypeDPA;
        case DBJKeyChainStoreAuthenticationTypeRPA:
            return kSecAttrAuthenticationTypeRPA;
        case DBJKeyChainStoreAuthenticationTypeHTTPBasic:
            return kSecAttrAuthenticationTypeHTTPBasic;
        case DBJKeyChainStoreAuthenticationTypeHTTPDigest:
            return kSecAttrAuthenticationTypeHTTPDigest;
        case DBJKeyChainStoreAuthenticationTypeHTMLForm:
            return kSecAttrAuthenticationTypeHTMLForm;
        case DBJKeyChainStoreAuthenticationTypeDefault:
...
- (CFTypeRef)accessibilityObject
{
    switch (_accessibility) {
        case DBJKeyChainStoreAccessibilityWhenUnlocked:
            return kSecAttrAccessibleWhenUnlocked;
        case DBJKeyChainStoreAccessibilityAfterFirstUnlock:
            return kSecAttrAccessibleAfterFirstUnlock;
        case DBJKeyChainStoreAccessibilityAlways:
            return kSecAttrAccessibleAlways;
        case DBJKeyChainStoreAccessibilityWhenPasscodeSetThisDeviceOnly:
            return kSecAttrAccessibleWhenPasscodeSetThisDeviceOnly;
        case DBJKeyChainStoreAccessibilityWhenUnlockedThisDeviceOnly:
            return kSecAttrAccessibleWhenUnlockedThisDeviceOnly;
        case DBJKeyChainStoreAccessibilityAfterFirstUnlockThisDeviceOnly:
            return kSecAttrAccessibleAfterFirstUnlockThisDeviceOnly;
        case DBJKeyChainStoreAccessibilityAlwaysThisDeviceOnly:
...
{
    NSError *error = [NSError errorWithDomain:DBJKeyChainStoreErrorDomain code:DBJKeyChainStoreErrorInvalidArguments userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:DBJKeyChainStoreErrorDomain code:-67594 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
#endif
    NSError *error = [NSError errorWithDomain:DBJKeyChainStoreErrorDomain code:status userInfo:@{NSLocalizedDescriptionKey: message}];
...
{
    NSError *error = [NSError errorWithDomain:DBJKeyChainStoreErrorDomain code:-99999 userInfo:@{NSLocalizedDescriptionKey: message}];
    NSLog(@"error: [%@] %@", @(error.code), error.localizedDescription);
    return error;
}
...
@implementation DBJKeyChainStore (Deprecation)
