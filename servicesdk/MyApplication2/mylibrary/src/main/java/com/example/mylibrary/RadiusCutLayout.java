...
public class RadiusCutLayout extends ConstraintLayout {
    RadiusCutLayoutHelper mRCHelper;

    public RadiusCutLayout(Context context) {
        this(context, null);
    }

    public RadiusCutLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadiusCutLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mRCHelper = new RadiusCutLayoutHelper();
