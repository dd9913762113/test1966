...
public class RadiusCutLayoutHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RadiusCutConstraintLayout);
        mRoundAsCircle = ta.getBoolean(R.styleable.RadiusCutConstraintLayout_round_as_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.RadiusCutConstraintLayout_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.RadiusCutConstraintLayout_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.RadiusCutConstraintLayout_clip_background, false);
        int roundCorner = ta.getDimensionPixelSize(R.styleable.RadiusCutConstraintLayout_round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                R.styleable.RadiusCutConstraintLayout_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.RadiusCutConstraintLayout_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.RadiusCutConstraintLayout_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.RadiusCutConstraintLayout_round_corner_bottom_right, roundCorner);
        ta.recycle();
